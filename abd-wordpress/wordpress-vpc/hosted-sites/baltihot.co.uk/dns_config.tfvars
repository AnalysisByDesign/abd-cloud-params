...
public_apex_domain = "baltihot.co.uk"

subject_alternative_names = ["www.baltihot.co.uk"]

public_sub_domain = ""

delegate_set_name = "baltihot"

# The Wordpress subdomain equivalent
trg_apex_domain = "abd-wp.uk"

trg_sub_domain = "baltihotcouk"
...
# Extra DNS records that are required
dns_extra = [
  {
    type  = "TXT"
    name  = ""
    ttl   = "86400"
    value = "google-site-verification=ni6gQetUTBeidBZAzDQAj3cSra7dmzE_J4foADIUqsY###v=spf1 include:servers.mcsv.net ?all"
  },
  {
    type  = "CNAME"
    name  = "e21db9b0aecddd805094995abf15b7c3"
    ttl   = "86400"
